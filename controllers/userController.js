...
exports.userCreate = async function (req, res) {
    ...
    let user = User.create({ service_number: req.body.service_number, lastname: req.body.lastname, firstname: req.body.firstname, prom_id: req.body.prom_id, room: req.body.room, password: hash})
        .then(data => {
